...
public final class ActivityMergeBinding implements ViewBinding {
  ...
  private ActivityMergeBinding(@NonNull CoordinatorLayout rootView, @NonNull LinearLayout bottomBar,
      @NonNull Button btnImport, @NonNull Button btnMerge, @NonNull RecyclerView rvDocuments,
      @NonNull Toolbar toolbar, @NonNull TextView tvEmpty, @NonNull TextView tvInstruction,
  ...
  @NonNull
  public static ActivityMergeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMergeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_merge, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMergeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMergeBinding((CoordinatorLayout) rootView, bottomBar, btnImport, btnMerge,
          rvDocuments, toolbar, tvEmpty, tvInstruction, tvSelectionCount);
    }
